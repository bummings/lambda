  ...
  // Answer c: 4
  // Answer randomize: A random number between 0 and 1.
  ...
  // Answer: The const variable declared 'greeting' does not have
  // quotes around the string it's equal to (hello) and is 
  // therefore invalid. The variable sum is fine (comes to 11.4) 
  // and the variable x is also fine (results in 2).
